...
![Landing Page](FitLens-dev2/assets/screenshots/landing-page.png)

### Upload Flow — Front & Side View Capture

![Upload Flow](FitLens-dev2/assets/screenshots/upload-flow.png)

### Detection Method Selection

![Detection Method](FitLens-dev2/assets/screenshots/detection-method.png)

### Landmark Detection — Front View

![Landmark Detection - Front View](FitLens-dev2/assets/screenshots/landmark-front.png)

### Landmark Detection — Side View

![Landmark Detection - Side View](FitLens-dev2/assets/screenshots/landmark-side.png)
